    ...
    return (
        <section className=" max-container padding-container flex flex-col gap-20 py-10 pb-32 md:gap-28 lg:py-20 xl:flex-row ">
                    ...
                    <div className="flex items-center gap-2">
                        {
                            Array(5).fill(1).map((_, index) => (
                                <Image key={index} src="/star.svg" alt="star" height={24} width={24} />
                            ))
                        }
                    </div>
            ...
            <div className="flex relative flex-1 items-start ">
                <div className="relative flex z-20 w-[260px] flex-col gap-8 rounded-3xl bg-gray-90 px-7 py-8">
                    ...
                    <div className="flexBetween">
                        <div className="flex flex-col">
                            ...
                            <p className="bold-20 text-white">189.28 km</p>
                        </div>
                        <div className="flex flex-col">
